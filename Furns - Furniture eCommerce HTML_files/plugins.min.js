    ...
    e.fn.extend({
        venobox: function(L) {
            ...
            return se.cb_init(ee), this.each(function() {
                ...
                function L() { C = N.data("gall"), x = N.data("numeratio"), k = N.data("gallItems"), p = N.data("infinigall"), H = N.data("share"), o.html(""), "iframe" !== N.data("vbtype") && "inline" !== N.data("vbtype") && "ajax" !== N.data("vbtype") && (Q = { pinterest: '<a   href="https://pinterest.com/pin/create/button/?url=' + N.prop("href") + "&media=" + N.prop("href") + "&description=" + _ + '">' + Z + "</a>", facebook: '<a   href="https://www.facebook.com/sharer/sharer.php?u=' + N.prop("href") + '">' + F + "</a>", twitter: '<a   href="https://twitter.com/intent/tweet?text=' + _ + "&url=" + N.prop("href") + '">' + G + "</a>", linkedin: '<a   href="https://www.linkedin.com/sharing/share-offsite/?url=' + N.prop("href") + '">' + J + "</a>", download: '<a   href="' + N.prop("href") + '">' + K + "</a>" }, e.each(H, function(e, s) { o.append(Q[s]) })), (g = k || e('.vbox-item[data-gall="' + C + '"]')).length < 2 && (p = !1, x = !1), z = g.eq(g.index(N) + 1), B = g.eq(g.index(N) - 1), z.length || !0 !== p || (z = g.eq(0)), g.length >= 1 ? (U = g.index(N) + 1, t.html(U + " / " + g.length)) : U = 1, !0 === x ? t.show() : t.hide(), "" !== _ ? c.show() : c.hide(), z.length || !0 === p ? (e(".vbox-next").css("display", "block"), P = !0) : (e(".vbox-next").css("display", "none"), P = !1), g.index(N) > 0 || !0 === p ? (e(".vbox-prev").css("display", "block"), M = !0) : (e(".vbox-prev").css("display", "none"), M = !1), !0 !== M && !0 !== P || (n.on(de.DOWN, ce), n.on(de.MOVE, re), n.on(de.UP, le)) }
